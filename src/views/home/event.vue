      ...
      <div class="main">
        <card>
          <card-content class="header">
            <router-link class="nickname" tag="span" :to="{name: 'user', query: {id: e.user.userId}}">{{e.user.nickname}}</router-link>
          ...
          <card-media>
            ...
            <router-link :to="{name: 'musicPlayer', query: {id: e.song.id}}" tag="div" class="list music">
              <list-item>
                <avatar class="rect">
